...
func (x *InsertUserPayload) Reset() {
	*x = InsertUserPayload{}
...
func (x *InsertUserPayload) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InsertUserPayload) ProtoMessage() {}

func (x *InsertUserPayload) ProtoReflect() protoreflect.Message {
	mi := &file_user_v1_user_service_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use InsertUserPayload.ProtoReflect.Descriptor instead.
func (*InsertUserPayload) Descriptor() ([]byte, []int) {
	return file_user_v1_user_service_proto_rawDescGZIP(), []int{0}
}

func (x *InsertUserPayload) GetUser() *User {
	if x != nil {
		return x.User
	}
	return nil
...
const file_user_v1_user_service_proto_rawDesc = "" +
	"\n" +
	"\x1auser/v1/user_service.proto\x12\auser.v1\x1a\x12user/v1/user.proto\"6\n" +
	"\x11InsertUserPayload\x12!\n" +
	...
	"\vUserService\x12E\n" +
	"\n" +
	"InsertUser\x12\x1a.user.v1.InsertUserPayload\x1a\x1b.user.v1.InsertUserResponseBf\n" +
	"\vcom.user.v1B\x10UserServiceProtoP\x01Z\b.;userPb\xa2\x02\x03UXX\xaa\x02\aUser.V1\xca\x02\aUser\\V1\xe2\x02\x13User\\V1\\GPBMetadata\xea\x02\bUser::V1b\beditionsp\xe8\a"
...
var file_user_v1_user_service_proto_goTypes = []any{
	(*InsertUserPayload)(nil),  // 0: user.v1.InsertUserPayload
	(*InsertUserResponse)(nil), // 1: user.v1.InsertUserResponse
	(*User)(nil),               // 2: user.v1.User
}
var file_user_v1_user_service_proto_depIdxs = []int32{
	2, // 0: user.v1.InsertUserPayload.user:type_name -> user.v1.User
	0, // 1: user.v1.UserService.InsertUser:input_type -> user.v1.InsertUserPayload
	1, // 2: user.v1.UserService.InsertUser:output_type -> user.v1.InsertUserResponse
